...
@NgModule({
  ...
  providers: [{provide: ErrorHandler, useClass: IonicErrorHandler},WishListService,GetRequestedBooks,GetReportsService,TransferAdminService,AdminHomeBodyService,GetIsbn,BarcodeService,HomeBodyService,Authenticate,Search,AdalService,IssueService,GetBook,ProfileService,RecommendationService,Myissuedhistory,{provide: APP_BASE_HREF, useValue: '/'}]
})
